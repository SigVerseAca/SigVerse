...
export default function Login() {
  ...
  const panelCopy = {
    ...
    'signup-otp': {
      ...
      title: 'One quick step to finish signup',
      text: 'Enter the OTP we sent so we can confirm the account before activation.'
    },
    forgot: {
      eyebrow: 'Recover access',
      title: 'Request a password reset OTP',
      text: 'We will send a one-time code to the email address connected to your account.'
    },
    reset: {
      eyebrow: 'Choose a new password',
      title: 'Reset and get back in',
      text: 'Enter the OTP from your email, then set a fresh password for your account.'
    }
  }[view];
        ...
        <section className="login-showcase">
          ...
          <div className="login-showcase-brand">
            ...
            <div className="login-showcase-copy">
              ...
              <p className="login-subtitle">A full-stack learning platform for course discovery, guided learning, instructor delivery, and admin approvals.</p>
            </div>
          </div>
          ...
          <div className="login-trust-grid">
            ...
            <div className="login-trust-card">
              <strong>Hybrid auth model</strong>
              <span>Use GitHub OAuth or local email login, with OTP flows for signup and password recovery.</span>
            </div>
            <div className="login-trust-card">
        ...
        <div className="login-card login-card-wide">
          <div className="login-card-inner">
            <div className="login-panel-copy">
              <span className="login-panel-eyebrow">{panelCopy.eyebrow}</span>
              <h2 className="login-panel-title">{panelCopy.title}</h2>
              <p className="login-panel-text">{panelCopy.text}</p>
            </div>
